                        ...
                        <div className="col-lg-12 text-center">
                            <div className="breadcrumb__text">
                                ...
                                <div className="breadcrumb__option">
                                    ...
                                    <Link to='/'>Shoes</Link>
                                    <Link to='/shopDetails'><span>Shoes Package</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="product__details__text">
                                ...
                                <div className="product__details__price">&#8377;599.00</div>
                                ...
                                <Link to='/login'><a className="site-btn link-light">ADD TO CARD</a></Link>
